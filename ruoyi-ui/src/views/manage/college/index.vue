...
<script>
import { listCollege, getCollege, delCollege, addCollege, updateCollege } from "@/api/manage/college";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除学院管理编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('manage/college/export', {
        ...this.queryParams
