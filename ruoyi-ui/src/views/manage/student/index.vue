<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="学生籍贯" prop="born">
        <el-input
      ...
      <el-form-item label="学生绩点" prop="gpa">
        <el-input
...
<!--      <el-table-column label="编号" align="center" prop="id" />-->
      ...
      <el-table-column label="学生籍贯" align="center" prop="born" />
      <el-table-column label="学生班级" align="center" prop="classname" />
      <el-table-column label="学生绩点" align="center" prop="gpa" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="学生籍贯" prop="born">
          <el-input v-model="form.born" placeholder="请输入学生籍贯" />
        </el-form-item>
        <el-form-item label="学生班级" prop="classname">
          <el-input v-model="form.classname" placeholder="请输入学生班级" />
        </el-form-item>
        <el-form-item label="学生绩点" prop="gpa">
          <el-input v-model="form.gpa" placeholder="请输入学生绩点" />
        </el-form-item>
      </el-form>
